...
export default function Sudoku(){
  ...
  const{start,restart:trackRestart,reset:resetRound}=useGameAnalytics("sudoku",s.grid.every((value,index)=>value===solution[index])?"complete":null);
